...
function index() {
  ...
  function getdata() {
    const options = {
      method: "GET",
      url: "http://localhost:8000/api/trades/timeframe",
    };
      ...
      <div className="themainclass">
        ...
        <div className="thedashsection">
          {data?.map((data) => {
            return (
              <>
                {data._id && data._id === timeframe ? (
                  <>
                    <div className="mgchart">
                      <Bar
                        charttitle={`Chart for ${data._id} timeframe`}
                    ...
                    <div className="mainkl">
                      <div>
                        Timeframe <span className="jiclass">{data._id}</span>
                      </div>
                      <div>
                        No. of Trades
