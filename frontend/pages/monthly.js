...
import { monthyearcapital } from "monthyear";
...
function index() {
  ...
  function getdata(date) {
    const options = {
      method: "get",
      url: "http://localhost:8000/api/trades/monthly",
    };
                ...
                {data._id && data._id === stock ? (
                  <>
                    <div className="mgchart">
                      <Bar
                        charttitle={`Chart for ${monthyearcapital(data._id)} `}
